    ...
    <div class="container">
        <div class="row mt-5"> <!-- v-if="$gate.isClientAdmin()" -->
            ...
            <div class="card-header">
              <h3 class="card-title">Team Leads</h3>
                      ...
                      <div class="row">
                          <div class="col-sm-12">
                              <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                ...
                                <tbody>
                                    <tr role="row" class="odd" v-for="lead in leads.data" :key="lead.id">
                                        <td>{{lead.id}}</td>
            ...
            <div class="card-footer">
                <pagination :data="leads" @pagination-change-page="getResults"></pagination>
            </div>
          </div>
            </div>
        </div>
    ...
    export default {
        ...
        methods:{
            loadTeamleads(){
                ...
                this.$Progress.start()
                axios.get('api/teamleadsmar').then(({data})=>(this.leads = data));
                this.$Progress.finish()
            },
            getResults(page = 1) {
			    axios.get('api/teamleadsmar?page=' + page)
				.then(response => {
